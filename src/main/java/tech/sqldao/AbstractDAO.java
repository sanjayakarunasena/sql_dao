...
import tech.sqldao.annotation.DefaultType;
...
public abstract class AbstractDAO {
    ...
    /**
     * Create an object in the database and return the keys generated by this query.
     * 
     * @param methodIndex
     *            Query map key to discover the corresponding {@link Query} from the {@link DaoMethods} for this method.
     * @param resultType
     ...
     * @param paramValues
     *            Query parameter values
     * @return T Object encapsulating generated keys.
     * @throws DAOTransientException
     * @throws DBConfigException
     */
    public <T> T createAndGetKeys(int methodIndex, Class<T> resultType, Object... paramValues)
            throws DAOTransientException, DBConfigException {
        return createAndGetKeys(retryCount, methodIndex, resultType, paramValues);
    }
     ...
     * @throws DBConfigException
     */
    private <T> T createAndGetKeys(int retryCountOnTransientException, int methodIndex, Class<T> resultType,
            Object... paramValues) throws DAOTransientException, DBConfigException {
        PreparedStatement ps = null;
        ResultSet rs = null;
        // Find the method corresponding the query intend to execute.
        ...
        try {
            ...
            ps = prepareStatement(con, query, paramValues, query.paramTypes());
            ps.executeUpdate();
            // Retrieve the generated keys by this query
            ...
            if (retryCountOnTransientException <= 0) {
                ...
                // Retry "retry count" times if a transient exception occurred after a little delay.
                ThreadUtil.delay(500);
                return createAndGetKeys(retryCountOnTransientException--, methodIndex, resultType, paramValues);
            } else {
                throw new DAOTransientException(CommonMsg.ERROR_DATA_INSERT_AFTER_RETRY, sqlte);
            }
        } catch (SQLException sqle) {
    ...
    /**
     * Map the values in the {@link ResultSet} to a list of T objects using the method
     * {@link #createValueObj(Class, ResultSet, boolean, Column...)}.
     * 
     * @param resultElementType
    ...
    private Object getColumnValue(ResultSet rs, Column column) throws SQLException {
        if (column.type() == DefaultType.class) {
